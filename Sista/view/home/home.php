            ...
            <?php  $i=1; foreach($dosen_pembimbing_1 as $dospem1) { ?>
              <?php if ($dospem1->asal == "ITERA") { ?>
                ...
                <div class="card border-primary " style="height:90%;">
                  <div class="card-body">
                    <h5 class="card-title"><a href="<?php echo base_url('bimbingan1/read1/'.$dospem1->id_dospem1) ?>"><?php echo $dospem1->nama_dospem ?></a></h5>
            ...
            <table class="table table-hover table-striped table-bordered" id="dataTables-example">
              ...
              <?php  $i=1; foreach($dosen_pembimbing_1 as $dospem1) { ?>
                <?php if ($dospem1->asal == "LAIN") { ?>
                  <tr>
                    <td class="bg-secondary text-light"><?php echo $i?></td>
                    <td><a class="text-primary text-center" href="<?php echo base_url('bimbingan1/read1/'.$dospem1->id_dospem1) ?>" ><?php echo $dospem1->nama_dospem ?></a></td>
            ...
            <div class="row">
              <?php  $i=1; foreach($dosen_pembimbing_2 as $dospem2) { ?>
                <div class="col-md-4 lg p-1">
                  <div class="card border-primary " style="height:90%;">
                    <div class="card-body">
                      <h5 class="card-title"><a href="<?php echo base_url('bimbingan2/read2/'.$dospem2->id_dospem2) ?>"><?php echo $dospem2->nama_dospem ?></a></h5>
