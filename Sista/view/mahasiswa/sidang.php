    ...
    <div class="row">
      <div class="col-md-8 mb-5">
            <?php
                ...
                echo form_open_multipart(base_url('/mahasiswa/sidang/daftar_sidang'));
        ...
        <input type="hidden" name="status" value="0">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group form-group-md">
                        <label>Upload Form Pendaftaran Sidang Proposal <span class="text-danger"><small>(Upload hanya file .PDF)</small></span></label>
