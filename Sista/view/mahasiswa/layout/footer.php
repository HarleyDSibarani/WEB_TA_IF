  ...
  <footer class="py-5 " style="background-color:#007bff">
    <div class="container">
      <p class=" m-0 text-center text-white">Copyright &copy; Sistem Informasi Management Skripsi Online 2019</p>
    </div>
    <!-- /.container -->
  </footer>
  ...
  <script src="<?php echo base_url() ?>assets/admin/js/custom1.js"></script>
</body>
