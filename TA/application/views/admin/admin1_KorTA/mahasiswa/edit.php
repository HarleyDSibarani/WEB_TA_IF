<?php
  ...
  echo form_open(base_url('admin/admin1/mahasiswa/edit/'.$mahasiswa->id_mhs));
...
<div class="card">
    ...
    <div class="col-md-6">
        <div class="form-group form-group-md">
            ...
            <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama" value="<?php echo $mahasiswa->nama ?>" required>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group form-group-md">
            ...
            <?php if($mahasiswa->id_dosen == $dosen->id_dosen) { echo "selected"; } ?>
    ...
    <div class="col-md-6">
        <div class="form-group form-group-md">
            ...
            <input type="text" name="tgl_daftar" class="form-control" placeholder="Tanggal Daftar" value="<?php echo $mahasiswa->tgl_daftar ?>" required>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group form-group-md">
            ...
            <input type="text" name="tgl_seminar" class="form-control" placeholder="Tanggal Seminar" value="<?php echo $mahasiswa->tgl_seminar ?>" required>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group form-group-md">
            ...
            <input type="text" name="tgl_sidang" class="form-control" placeholder="Tanggal Sidang" value="<?php echo $mahasiswa->tgl_sidang ?>" required>
        </div>
    </div>
