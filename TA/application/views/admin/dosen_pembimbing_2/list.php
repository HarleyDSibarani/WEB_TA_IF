            ...
            <table class="table table-hover table-striped">
                ...
                <?php  $i=1; foreach($dosen as $dospem2) { ?>
                    <tr class="odd gradex">
                        ...
                        <td><?php echo $dospem2->beban?></td>
                        <td>
                            <?php
                                if (($admin_aktif->id_tingkatan) != 1 ) {

                                }else { ?>
                                    <a href="<?php echo base_url('admin/dosen_pembimbing_2/edit/'.$dospem2->id_dospem2) ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
