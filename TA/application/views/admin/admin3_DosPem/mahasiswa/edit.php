<?php
  ...
  echo form_open(base_url('admin/admin3/mahasiswa/edit/'.$admin->id_admin));
...
<div class="card">
    ...
    <div class="col-md-6">
        <div class="form-group form-group-md">
            <label>NIP/NRK</label>
            <input type="text" name="nip" class="form-control" placeholder="Masukkan NIP/NRK" value="<?php echo $admin->nip ?>" required>
        </div>
    </div>
