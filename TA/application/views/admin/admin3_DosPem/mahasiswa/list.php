...
<div class="col-md-12">
    <div class="card">
        <div class="header">
            ...
            <p><a href="<?php echo base_url('admin/admin3/mahasiswa/tambah') ?>" class="btn btn-primary">
            ...
            <table class="table table-hover table-striped">
                ...
                <?php  $i=1; foreach($mahasiswa as $mahasiswa) { ?>
                    <tr class="odd gradex">
                        ...
                        <td>
                            <a href="<?php echo base_url('admin/admin3/mahasiswa/edit/'.$mahasiswa->id_mhs) ?>"class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
