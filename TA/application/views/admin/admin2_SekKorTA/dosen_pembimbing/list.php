...
<div class="col-md-12">
    <div class="card">
        <div class="header">
            ...
            <p><a href="<?php echo base_url('admin/admin2/dosen_pembimbing/tambah') ?>" class="btn btn-primary">
            ...
            <table class="table table-hover table-striped">
                ...
                <?php  $i=1; foreach($dosen as $dosen) { ?>
                    <tr class="odd gradex">
                        ...
                        <td>
                            <a href="<?php echo base_url('admin/admin2/dosen_pembimbing/edit/'.$dosen->id_dosen) ?>"class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
