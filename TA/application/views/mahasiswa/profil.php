...
<head>
  ...
  <title><?php echo $mahasiswa->nama_mhs ?></title>
...
<body id="page-top">
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    <a class="navbar-brand js-scroll-trigger" >
      <img class="d-block d-lg-none img-thumbnail rounded-circle" width="60" src="<//?php echo base_url('./assets/upload/dosen/image/thumbs/'.$mahasiswa->foto) ?>">
      <span class="d-none d-lg-block">
        <img class="img-thumbnail img-profile rounded-circle mx-auto mb-2" src="<//?php echo base_url('./assets/upload/dosen/image/thumbs/'.$mahasiswa->foto) ?>">
      </span>
    </a>
    ...
    <div class="collapse navbar-collapse"  id="navbarSupportedContent">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger"><//?php echo $mahasiswa->nama_mhs ?></a>
        </li>
        <li class="nav-item">
        ...
        <h3 class="title text-primary text-center">Beban Bimbingan</h3>
            <div class="content table-responsive table-full-width">
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <td><a href="<?php echo base_url('mahasiswa/mhs')?>">asd</a></td>
                        <td>2</td>
                        <td>3</td>
                        <td>4</td>
                        <td>5</td>
