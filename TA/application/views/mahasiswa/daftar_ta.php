    ...
    <button class="btn-lg btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg" title="Daftar TA 1">Daftar TA 1</button>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo form_open_multipart(base_url('/mahasiswa/welcome'));
                    ?>      
                    <div class="col-md-12">
