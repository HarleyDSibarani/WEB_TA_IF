<?php
  ...
  echo form_open_multipart(base_url('admin/dosen_pembimbing_1/edit/'.$dosen->id_dospem1));
...
<div class="card clearfix">
    ...
    <div class="col-md-6">
        <div class="form-group form-group-md">
            <label>Email</label>
            <input type="text" name="email" class="form-control" placeholder="Masukkan Email" value="<?php echo $dosen->email ?>" readonly disable required>
        </div>
    </div>
        ...
        <div class="form-group form-group-md">
            <label>Asal</label>
             <select name="asal" class="form-control" required>
                <?php if($dosen->asal == "ITERA"){ ?>
                    <option selected>ITERA</option>
                    <option >LAIN</option>
                <?php }else{ ?>
                    <option >ITERA</option>
